  ...
  return (
    <div className="accounts__wrapper">
      <div className="accounts__header">
        ...
        {/* POS, TRANSFER AND CASH */}
        <section className="cards__accounts" style={{ marginTop: "2rem" }}>
          <div className="account__card income__method">
            <h1>POS</h1>{" "}
            <div
              className="view__more income__method"
              onClick={() => navigate("/accreports")}
            >
