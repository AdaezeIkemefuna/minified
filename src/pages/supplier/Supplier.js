...
function Supplier() {
  ...
  const { activeItem, setActiveItem, searchResult, setSearchResult } =
  ...
  const getAllSuppliers = async () => {
    try {
      const response = await fetch(
        `https://pos-server-cxqi.onrender.com/supply/suppliers`
      );
