...
const CancelOrder = (closeModal, setCancel, cancel) => {
  ...
  //   try {
  //     fetch("https://swift-lounge.herokuapp.com/ims/delete-item", {
  //       method: "DELETE",
  //       headers: {
  ...
  return (
    ...
    >
      <div className="close__modal" id="bg" onClick={closeModal}><AiOutlineCloseCircle size={25}/></div>
      <h4 style={{ padding: "0", margin: "0" }}>Are you sure you want to cancel this order </h4>
