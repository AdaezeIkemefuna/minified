      ...
      >
        ...
        >
          <div style={{ fontSize: "1.2rem" }}>
            <b>
              <span>Bar Total:</span> N{barTotal.toLocaleString("en-US")}
            </b>
          </div>
          <div style={{ fontSize: "1.2rem" }}>
            <b>
              <span>Lounge Total:</span> N{loungeTotal.toLocaleString("en-US")}
            </b>
          </div>
          <div style={{ fontSize: "1.2rem" }}>
            <b>
...
>>>>>>> 46491f86fcc0fe939969c2ca59ada5fa3371fd75
        ...
        >
          <div style={{ fontSize: "1.2rem" }}>
            <b>
              <span>Cash Payments:</span> N
              {adminCashPayments.toLocaleString("en-US")}{" "}
            </b>
          </div>
          <div style={{ fontSize: "1.2rem" }}>
            <b>
              <span>POS Payments:</span> N
              {adminPosPayments.toLocaleString("en-US")}{" "}
            </b>
          </div>
          <div style={{ fontSize: "1.2rem" }}>
            <b>
              <span>Transfer Payments:</span> N
              {adminTransferPayments.toLocaleString("en-US")}
            </b>
          </div>
        </div>
      </div>
...
>>>>>>> 46491f86fcc0fe939969c2ca59ada5fa3371fd75
        ...
        {bar.map((data, index) => (
          ...
          >
            ...
            <div className="table__row">
              N{data.price.toLocaleString("en-US")}
            </div>
            <div className="table__row">
              {data.quantity.toLocaleString("en-US")}
            </div>
            <div className="table__row">
              N{data.subtotal.toLocaleString("en-US")}
            </div>
          </div>
        ))}
      </div>
